...
CRITICAL ACTION: If this tool returns next_steps: "Supplementary information", you MUST call generate_question next. Do NOT call finish_step.""",
...
Parameters: {"all_questions_json": "JSON string of all generated questions from the draft", "expected_size": "expected survey size"}""",
...
WARNING: You CANNOT call this tool prematurely! You must ensure the core required tool for the current step has returned a Success message first."""
}